INSERT INTO `CAFE`('coworking','bornes',`capacite`,`pays`,`code_postal`,`est_ouvert`,'id_cafe') VALUES (1,1,50,'FRANCE','75002',0,3);
INSERT INTO `CAFE`('coworking','bornes',`capacite`,`pays`,`code_postal`,`est_ouvert`,'id_cafe') VALUES (1,1,50,'MAROC','75003',1,4);
INSERT INTO `CAFE`('coworking','bornes',`capacite`,`pays`,`code_postal`,`est_ouvert`,'id_cafe') VALUES (1,1,500,'ESPAGNE','92100',1,5);
...
INSERT INTO `Carte`(`code_pays`,`item_id`,'prix_petiti','prix_moyenni','prix_largi') VALUES ('USA',1,3,4,5);
INSERT INTO `Carte`(`code_pays`,`item_id`,'prix_petiti','prix_moyenni','prix_largi') VALUES ('USA',2,3,3.5,4);
INSERT INTO `Carte`(`code_pays`,`item_id`,'prix_petiti','prix_moyenni','prix_largi') VALUES ('USA',3,4,5,6);
INSERT INTO `Carte`(`code_pays`,`item_id`,'prix_petiti','prix_moyenni','prix_largi') VALUES ('USA',4,4,5,6);
INSERT INTO `Carte`(`code_pays`,`item_id`,'prix_petiti','prix_moyenni','prix_largi') VALUES ('USA',5,3,4,5);
INSERT INTO `Carte`(`code_pays`,`item_id`,'prix_petiti','prix_moyenni','prix_largi') VALUES ('USA',6,4,5,6);
                                                                                              
INSERT INTO `Carte`(`code_pays`,`item_id`,'prix_petiti','prix_moyenni','prix_largi') VALUES ('USA',7,2,NULL,NULL);
INSERT INTO `Carte`(`code_pays`,`item_id`,'prix_petiti','prix_moyenni','prix_largi') VALUES ('USA',8,2,NULL,NULL);
INSERT INTO `Carte`(`code_pays`,`item_id`,'prix_petiti','prix_moyenni','prix_largi') VALUES ('USA',9,3,NULL,NULL);
INSERT INTO `Carte`(`code_pays`,`item_id`,'prix_petiti','prix_moyenni','prix_largi') VALUES ('USA',10,4,NULL,NULL);
INSERT INTO `Carte`(`code_pays`,`item_id`,'prix_petiti','prix_moyenni','prix_largi') VALUES ('USA',11,3,NULL,NULL);
...
INSERT INTO `Menu`(`id_menu`,`nom`,`reduction`,`code_pays`) VALUES (5,'GOUTER FROID',15,'USA');
INSERT INTO `Menu`(`id_menu`,`nom`,`reduction`,`code_pays`) VALUES (6,'GOUTER CHAUD',15,'USA');
